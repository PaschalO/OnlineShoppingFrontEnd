...
@NgModule({
	declarations: [InputNumberFormComponent, CartSubtotalComponent],
	imports: [CommonModule, HeadersModule, FormsModule, AngularMaterialModule],
	exports: [InputNumberFormComponent, CartSubtotalComponent]
})
